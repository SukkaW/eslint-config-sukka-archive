...
export const RULE_NAME = 'typescript/generic-spacing';
  ...
  create: (context) => {
    ...
    return {
      TSTypeParameterDeclaration: (node) => {
        if (node.parent && !['TSCallSignatureDeclaration', 'ArrowFunctionExpression', 'TSFunctionType'].includes(node.parent.type)) {
